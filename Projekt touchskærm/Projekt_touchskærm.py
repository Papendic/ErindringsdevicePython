...
class TetsGUI:
	...
	Bruger1 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede, command=OpenNewWindow.openNewWindow)
	Bruger1.pack()
	Bruger1.place(x=100,y=50)

	Bruger2 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede)
	Bruger2.pack()
	Bruger2.place(x=250,y=50)
	
	Bruger3 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede)
	Bruger3.pack()
	Bruger3.place(x=400,y=50)

	Bruger4 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede)
	Bruger4.pack()
	Bruger4.place(x=550,y=50)

	Bruger5 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede)
	Bruger5.pack()
	Bruger5.place(x=100,y=200)

	Bruger6 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede)
	Bruger6.pack()
	Bruger6.place(x=250,y=200)
	
	Bruger7 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede)
	Bruger7.pack()
	Bruger7.place(x=400,y=200)

	Bruger8 = Button(mainWindow.window, height ='100', width='100', bg = 'blue', fg='white', image=Pictures.newBruger1Billede)
	Bruger8.pack()
