...
class TetsGUI:
	...
	Mute = Button(mainWindow.window, height ='40', width='40', bg = 'blue', fg='white', image=newMuteBilledeResize)
	Mute.pack()
	Mute.place(x=100,y=350)

	Lyd1 = Button(mainWindow.window, height ='40', width='40', bg = 'blue', fg='white', image=newLyd1BilledeResize)
	Lyd1.pack()
	Lyd1.place(x=150,y=350)

	Lyd2 = Button(mainWindow.window, height ='40', width='40', bg = 'blue', fg='white', image=newLyd2BilledeResize)
	Lyd2.pack()
	Lyd2.place(x=200,y=350)

	Lyd3 = Button(mainWindow.window, height ='40', width='40', bg = 'blue', fg='white', image=newLyd3BilledeResize)
	Lyd3.pack()
